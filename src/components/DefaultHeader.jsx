...
const DefaultHeader = ({ title, content }) => {
  return (
    <div className="mt-10 w-[80%] mx-auto font-primary">
      <div className="flex flex-col items-center justify-center space-y-3">
        <div className="relative w-fit pb-2">
          ...
          {/* Bottom border */}
          <div className="absolute left-0 right-0 bottom-0 h-[4px] rounded-r-lg rounded-l-lg bg-gray-300"></div>

          {/* Moving dot */}
          <div className="absolute bottom-[-3px] left-0 w-full h-3 pointer-events-none">
