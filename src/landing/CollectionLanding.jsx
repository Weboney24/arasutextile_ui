...
return (
  <div className="mb-40">
    ...
    <div className="flex w-[90%] mx-auto gap-8 mt-10">
      {/* Sidebar */}
      <aside className="w-[20%] hidden md:block sticky top-32 h-fit">
      ...
      <section className="w-[80%] flex flex-col gap-5">
        ...
        <div className={`${activeSubCategory && selectedProduct?.description ? "" : "gap-10"} flex flex-row items-center  `}>
          <div className={`${activeSubCategory && selectedProduct?.description ? "" : "w-[50%]"}`}>
          ...
          {/* Image Display */}
          <div className={`${activeSubCategory && selectedProduct?.description ? "" : "w-[50%]"} flex items-center justify-between px-3 py-3`}>
